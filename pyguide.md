...
Python is the main dynamic language used at Helixgade. This style guide is a list
...
5.  **Deprecated:** application-specific imports that are part of the same
    ...
    You may find older Helixgade Python Style code doing this, but it is no longer
