...
The Helixgade R Style Guide is a fork of the
[Tidyverse Style Guide](https://style.tidyverse.org/) by Hadley Wickham
[license](https://creativecommons.org/licenses/by-sa/2.0/). Helixgade modifications
were developed in collaboration with the internal R user community. The rest of
this document explains Helixgade's primary differences with the Tidyverse guide,
...
Helixgade prefers identifying functions with `BigCamelCase` to clearly distinguish
...
NAMESPACE. Helixgade has a very big R codebase, and importing all functions creates
